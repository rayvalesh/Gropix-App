...
public class AppCompactBehavior extends CoordinatorLayout.Behavior<FrameLayout> {
    ...
    @Override
    public boolean onNestedPreFling(@NonNull CoordinatorLayout coordinatorLayout, @NonNull FrameLayout child, @NonNull View target, float velocityX, float velocityY) {
        view = child;
