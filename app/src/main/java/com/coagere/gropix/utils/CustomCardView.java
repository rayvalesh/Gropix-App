...
public class CustomCardView extends View {

    public static final String TAG = CustomCardView.class.getSimpleName();
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.CustomCardView);
            mOrientation = typedArray.getInt(R.styleable.CustomCardView_ticketOrientation, Orientation.HORIZONTAL);
            mBackgroundColor = typedArray.getColor(R.styleable.CustomCardView_ticketBackgroundColor, getResources().getColor(android.R.color.white));
            mScallopRadius = typedArray.getDimensionPixelSize(R.styleable.CustomCardView_ticketScallopRadius, dpToPx(20f, getContext()));
            mScallopPositionPercent = typedArray.getFloat(R.styleable.CustomCardView_ticketScallopPositionPercent, 50);
            mShowBorder = typedArray.getBoolean(R.styleable.CustomCardView_ticketShowBorder, false);
            mBorderWidth = typedArray.getDimensionPixelSize(R.styleable.CustomCardView_ticketBorderWidth, dpToPx(2f, getContext()));
            mBorderColor = typedArray.getColor(R.styleable.CustomCardView_ticketBorderColor, getResources().getColor(android.R.color.black));
            mShowDivider = typedArray.getBoolean(R.styleable.CustomCardView_ticketShowDivider, false);
            mDividerType = typedArray.getInt(R.styleable.CustomCardView_ticketDividerType, DividerType.NORMAL);
            mDividerWidth = typedArray.getDimensionPixelSize(R.styleable.CustomCardView_ticketDividerWidth, dpToPx(2f, getContext()));
            mDividerColor = typedArray.getColor(R.styleable.CustomCardView_ticketDividerColor, getResources().getColor(android.R.color.darker_gray));
            mDividerDashLength = typedArray.getDimensionPixelSize(R.styleable.CustomCardView_ticketDividerDashLength, dpToPx(8f, getContext()));
            mDividerDashGap = typedArray.getDimensionPixelSize(R.styleable.CustomCardView_ticketDividerDashGap, dpToPx(4f, getContext()));
            mCornerType = typedArray.getInt(R.styleable.CustomCardView_ticketCornerType, CornerType.NORMAL);
            mCornerRadius = typedArray.getDimensionPixelSize(R.styleable.CustomCardView_ticketCornerRadius, dpToPx(4f, getContext()));
            mDividerPadding = typedArray.getDimensionPixelSize(R.styleable.CustomCardView_ticketDividerPadding, dpToPx(10f, getContext()));
            float elevation = 0f;
            if (typedArray.hasValue(R.styleable.CustomCardView_ticketElevation)) {
                elevation = typedArray.getDimension(R.styleable.CustomCardView_ticketElevation, elevation);
            } else if (typedArray.hasValue(R.styleable.CustomCardView_android_elevation)) {
                elevation = typedArray.getDimension(R.styleable.CustomCardView_android_elevation, elevation);
            }
            if (elevation > 0f) {
